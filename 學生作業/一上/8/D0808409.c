...
int main(){
    ...
    def[2]=7;
    //輸入輸出
    Print(1,char1_name,type[0],hp[0],atk[0],def[0]);
    puts("");//換行
    Print(2,char2_name,type[1],hp[1],atk[1],def[1]);
    puts("");
    Print(3,char3_name,type[2],hp[2],atk[2],def[2]);
    puts("");
    while(1)
    {
        int choose;
       ...
       // puts("");
        ...
        else if(choose==1)
        {
            ...
            puts("");
            Print(4,char4_name,toupper(type[3]),hp[3],atk[3],def[3]);
            puts("");
        ...
        {
            puts("");
            Print(1,char1_name,toupper(type[0]),hp[0],atk[0],def[0]);
            puts("");
            Print(2,char1_name,toupper(type[1]),hp[1],atk[1],def[1]);
            puts("");
            Print(3,char1_name,toupper(type[2]),hp[2],atk[2],def[2]);
            puts("");
            if(chara_Total>3)
            {
                Print(4,char4_name,toupper(type[3]),hp[3],atk[3],def[3]);
