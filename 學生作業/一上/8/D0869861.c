...
int main () {
    ...
    float power1,power2,power3,mod1,mod2,hit1,hit2,bloodmod1=1,bloodmod2=1;
    ...
    while (scanf("%d",&option)!=EOF) {
        ...
        case 1: //Add or modify new role
            ...
            float power4 = ( newchar4_hp * 1.0 + newchar4_atk * 0.8 + newchar4_def * 0.5 - 50 ) * 6.5; // power calculation

            printf("\nCharacter4 \n"
                   "Kevin \n"
                   "Type=%c     HP=%d \n"
                   "ATK=%d     DEF=%d\n"
                   "Power Level= %.2f\n\n",newchar4_type,newchar4_hp,newchar4_atk,newchar4_def,power4); // output
            break;
