...
int main(){
	...
	int lastone_type;
    //前三個的角色強度預測
    int power1 = (char1_hp[0] * 1.0 + char1_atk[0] * 0.8 + char1_def[0] * 0.5 - 50 ) * 6.5;
    int power2 = (char2_hp[0] * 1.0 + char2_atk[0] * 0.8 + char2_def[0] * 0.5 - 50 ) * 6.5;
    int power3 = (char3_hp[0] * 1.0 + char3_atk[0] * 0.8 + char3_def[0] * 0.5 - 50 ) * 6.5;
    //新增的相關變數
	int start; 
	//新增或修改新增角色的計數器
